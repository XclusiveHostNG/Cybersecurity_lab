...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <form action="/handlers/admin/campaign-edit-handler.php" method="post" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="content" rows="5" class="form-control"><?php echo htmlspecialchars($campaign['content']); ?></textarea>
                </div>
                <div class="col-12">
