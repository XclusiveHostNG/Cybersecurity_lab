...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="fa fa-id-card me-2 text-primary"></i>KYC Documents</h5>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    try {
                        $stmt = db()->prepare("SELECT k.*, u.first_name, u.last_name FROM kyc_documents k JOIN users u ON k.owner_id = u.id WHERE k.owner_type = 'user' ORDER BY k.created_at DESC");
                        $stmt->execute();
                    ...
                    if (empty($documents)) {
                        echo '<tr><td colspan="5" class="text-center text-muted">No KYC documents uploaded.</td></tr>';
                    } else {
